  ...
  return(
    <Render>
      ...
      <main>
        ...
        <div>
          <h1>Interestellar</h1> <StarRank />
        </div>

        <div class="user_add_movie">
          <img src="https://github.com/MatheusBorgesDev.png" alt="Imagem do usuário" /> <p>Por Matheus Borges</p>

          <FiClock /> <p>18/08/2023 às 06:51</p>
        </div>
